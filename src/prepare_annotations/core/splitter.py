"""
Variant splitting utilities for parquet files.
"""
import time
...
from prepare_annotations.core.config import get_default_workers
from prepare_annotations.core.models import SplitResult, PreparationResult
