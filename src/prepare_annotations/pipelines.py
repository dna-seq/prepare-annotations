...
def split_parquets(
    ...
    from prepare_annotations.core.splitter import split_variants_by_tsa
    ...
    def upload_dataset_to_hf(
        ...
        config = {
            "clinvar": {
                ...
                "default_source": get_default_cache_dir("clinvar")
            },
            "ensembl": {
                "repo": "just-dna-seq/ensembl_variations",
                "card": generate_ensembl_card,
                "default_source": get_default_cache_dir("ensembl")
            },
            "dbsnp": {
                "repo": "just-dna-seq/dbsnp",
                "card": generate_dbsnp_card,
                "default_source": get_default_cache_dir("dbsnp_grch38")
            },
            "dbsnp_t2t": {
                "repo": "just-dna-seq/dbsnp_t2t",
                "card": generate_dbsnp_t2t_card,
                "default_source": get_default_cache_dir("dbsnp_t2t")
            },
            "gnomad": {
                "repo": "just-dna-seq/gnomad",
                "card": generate_gnomad_card,
                "default_source": get_default_cache_dir("gnomad_v4")
            }
        }
        ...
        if source_dir is None:
            ...
            if not source_dir.exists() and dataset_type.lower() == "dbsnp":
                source_dir = get_default_cache_dir("dbsnp_grch37")
            elif not source_dir.exists() and dataset_type.lower() == "gnomad":
                source_dir = get_default_cache_dir("gnomad_v3")
